...
var CardPool = class extends EventEmitter {
...
// src/cards/cardEngine.ts
var CardEngine = class extends EventEmitter2 {
  constructor(config) {
    super();
    this.config = config;
  ...
  async sample(limit, options = {}) {
    ...
    for (let i = 0; i < limit; i++) {
      ...
      if (selectedType.rarities) {
        selectedRarity = $.rnd.weighted(selectedType.rarities, (r) => r.compiledWeight).rarity;
      }
      let candidates;
